            ...
            <aside>
                ...
                <form action="#" method="post" accept-charset="utf-8">
                    <div class="controls controls-row">
                        <input type="text" name="title" id="title" placeholder="Titre" class="span5">
                        ...
                        <span class="dropdown">
                            <a href="#" data-toggle="dropdown" class="btn btn-large dropdown-toggle" id="current-category">Category <b class="caret"></b></a>
                    ...
                    <div class="controls controls-row" >
                        <input type="file" id="headimg" class="file filestyle" data-classButton="btn btn-large btn-upload" data-buttonText="Charger une photo" data-input="false"> <button id="selectBtn" style="display: none;" class="btn btn-large btn-upload">Selectionner</button>
                        <span id="croppedControls" style="display: none;"><button id="toggleTitle" class="btn btn-large btn-upload">View/Hide icon</button> <button id="toggleHeader" class="btn btn-large btn-upload">Voir/Cacher le titre</button></span>
                        <p id="file-message">Use an image of at least 800*600</p>
                        <div id="prev_headimg"></div>
                        <div class="container">
                            <div id="results">
                                <img id="crop_result_title" style="border-radius: 200px 200px 200px 200px;height: 183px;width: 183px;display:none;" />
                                <img id="crop_result_header" />
                            </div>
                            <canvas id="panel" style="display: none;"></canvas>
                        </div>
                        <input type="hidden" id="image_title" name="image_title" value="" />
                        <input type="hidden" id="image_header" name="image_header" value="" />
                    </div>
                    <div class="controls controls-row" >
                        <textarea rows="5" name="description" id="description" placeholder="Description" class="span10"></textarea>
                    </div>
                    ...
                    <div class="buttons clearfix">
                        <button type="submit" id="submit" class="btn btn-xlarge btn-tales-one">Publish</button>
                    </div>
                </form>
            </aside>
